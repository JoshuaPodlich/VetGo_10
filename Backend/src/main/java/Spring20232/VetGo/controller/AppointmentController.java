...
// Adds additional pet information to the appointment
    ...
    public ResponseEntity<?> acceptAppointment(@PathVariable("aid") Long aid, @PathVariable("vid") Long vid) {
        ...
        String messageClient = "Hello " + appointment.getPet().getOwner().getEmail() + ",\n\n" +
        ...
        String messageVet = "Hello " + vet.getEmail() + ",\n\n" +
        ...
        String clientEmail = appointment.getPet().getOwner().getEmail();
        String vetEmail = vet.getEmail();
